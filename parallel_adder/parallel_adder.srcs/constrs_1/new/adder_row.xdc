...
set_property PACKAGE_PIN F8  [get_ports {cin}]

set_property PACKAGE_PIN G16 [get_ports {s[0]}]
set_property PACKAGE_PIN H16 [get_ports {s[1]}]
set_property PACKAGE_PIN D16 [get_ports {s[2]}]
set_property PACKAGE_PIN D15 [get_ports {s[3]}]
set_property PACKAGE_PIN C18 [get_ports {s[4]}]
set_property PACKAGE_PIN C17 [get_ports {s[5]}]
set_property PACKAGE_PIN B19 [get_ports {s[6]}]
set_property PACKAGE_PIN C19 [get_ports {s[7]}]

set_property PACKAGE_PIN A17 [get_ports {cout[8]}]
...
set_property IOSTANDARD LVCMOS18 [get_ports {cout[8]}]
